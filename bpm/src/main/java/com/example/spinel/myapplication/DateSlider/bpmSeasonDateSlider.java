...
public class bpmSeasonDateSlider extends bpmDateSlider {

	public bpmSeasonDateSlider(Context context, OnDateSetListener l, Calendar calendar) {
		this(context, l, calendar, null, null);
	}
    public bpmSeasonDateSlider(Context context, OnDateSetListener l, Calendar calendar,
                               Calendar minDate, Calendar maxDate) {
        super(context, R.layout.bpm_dateslider_season, l, calendar, minDate, maxDate);
    }
    ...
    protected void setTitle() {
        if (mTitleText != null) {
            ...
            mTitleText.setText("选择时间:  " + df.format(c.getTime()) + " "+ bpmTools.getSeasonName(c));
        }
    }
