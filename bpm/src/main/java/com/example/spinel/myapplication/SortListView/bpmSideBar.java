...
public class bpmSideBar extends View {
    ...
    public bpmSideBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public bpmSideBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public bpmSideBar(Context context) {
        super(context);
    }
