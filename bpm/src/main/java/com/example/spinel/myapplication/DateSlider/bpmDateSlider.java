...
import com.example.spinel.myapplication.DateSlider.bpmSliderContainer.OnTimeChangeListener;
 ...
 */
public class bpmDateSlider extends Dialog {
...
//	private static String TAG = "DATESLIDER";
    ...
    protected bpmSliderContainer mContainer;
    protected int minuteInterval;


    public bpmDateSlider(Context context, int layoutID, OnDateSetListener l, Calendar initialTime) {
    	this(context,layoutID,l,initialTime, null, null, 1);
    }
    
    public bpmDateSlider(Context context, int layoutID, OnDateSetListener l, Calendar initialTime, int minInterval) {
    	this(context,layoutID,l,initialTime, null, null, minInterval);
    }
    
    public bpmDateSlider(Context context, int layoutID, OnDateSetListener l,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.bpm_dialogtitle);

        mTitleText = (TextView) this.findViewById(R.id.dateSliderTitleText);
        mContainer = (bpmSliderContainer) this.findViewById(R.id.dateSliderContainer);
        ...
        View view = findViewById(R.id.year_season);
        if(view!=null) {
            view.setTag("seasonyear");
        }
    }
    ...
    private View.OnClickListener okButtonClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            if (onDateSetListener!=null)
                onDateSetListener.onDateSet(bpmDateSlider.this, getTime());
            dismiss();
        }
    };
    ...
    protected void setTitle() {
        if (mTitleText != null) {
            ...
            SimpleDateFormat df = new SimpleDateFormat("y年 MMMM d日");
