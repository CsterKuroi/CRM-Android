 ...
 */
public class bpmWeekLabeler extends bpmLabeler {
    private final String mFormatString;

    public bpmWeekLabeler(String formatString) {
        super(120, 60);
    ...
    public bpmTimeObject add(long time, int val) {
        return timeObjectfromCalendar(bpmUtil.addWeeks(time, val));
    }
    ...
    protected bpmTimeObject timeObjectfromCalendar(Calendar c) {
        ...
        return new bpmTimeObject(String.format(mFormatString,week), startTime, endTime);
    }
