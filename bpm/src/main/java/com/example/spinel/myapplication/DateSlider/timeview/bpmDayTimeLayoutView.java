 ...
 */
public class bpmDayTimeLayoutView extends bpmTimeLayoutView {
     ...
     */
    public bpmDayTimeLayoutView(Context context, boolean isCenterView,
    ...
    public void setVals(bpmTimeView other) {
        super.setVals(other);
        bpmDayTimeLayoutView otherDay = (bpmDayTimeLayoutView) other;
