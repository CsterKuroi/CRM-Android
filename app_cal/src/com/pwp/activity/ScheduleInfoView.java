...
public class ScheduleInfoView extends Activity  implements  View.OnClickListener {
	...
	protected void  onCreate(Bundle savedInstanceState) {
		...
		time.setText(scheduleVO.getScheduleDate().substring(0,scheduleVO.getScheduleDate().length()-3));
								...
								//	Toast.makeText(ScheduleInfoView.this, "删除日程在服务器端的id" + scheduleid, Toast.LENGTH_LONG).show();
									...
									mConnection.connect(wsuri, new WebSocketHandler() {
										...
										public void onTextMessage(String payload) {
											...
											//Toast.makeText(ScheduleInfoView.this, "删除日程服务器返回结果：" + payload, Toast.LENGTH_LONG).show();
										}
