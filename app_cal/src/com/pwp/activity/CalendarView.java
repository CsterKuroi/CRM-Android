...
public class CalendarView extends BaseAdapter {
	...
	public void getCalendar(int year, int month){
		...
		Log.e("DAYyyyyyyyyyyyy", isLeapyear+" ======  "+daysOfMonth+"  ============  "+dayOfWeek+"  =========   "+lastDaysOfMonth);
		getweek(year,month);
	}
	...
	private void getweek(int year, int month) {
		...
		ArrayList<ScheduleDateTag> dateTagList = dao.getTagDate(userid,year,month);

		if(dateTagList != null && dateTagList.size() > 0){
			schDateTagFlag = new int[dateTagList.size()];
			//Toast.makeText(CalendarView.this, "biao ji de ge shu", Toast.LENGTH_LONG).show();
			Log.e("number","dddddddddddddddddddddddddddggggggggggggggddddddddddddddddddd"+dateTagList.size());
		}

		//Log.e("number","dddd"+dateTagList);
