 ...
 */
public class yh729_mSQLiteOpenHelper extends SQLiteOpenHelper {

    public static boolean first=true;
    private WebSocketConnection mmConnection = new WebSocketConnection();
    private Boolean isConnected = false;
    private String type11uri = "ws://192.168.50.11:8000/ws";
                    ...
                    try {
                        ...
                        for (int i = 0; i < usercomman.length(); i++) {
                            ...
                            db.execSQL("insert into group_notification " +
                                    "(creatorID,server_id,needconfirm,creatorName,joinerID,joinerName,title,content,create_time,type) values" +
                                    "('"+creater+"','"+server_id+"','"+type+"','"+"还没查"+"','"+joiner+"','"+"也还没查"
                                    +"','"+title+"','"+content+"','"+creat_time+"','send')");
    ...
    public yh729_mSQLiteOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            db.execSQL("insert into remind_time values ('group_notify', '100')");
...
//                    "('101','tom','102','jerry','cat and mouse','hahahaha6','6','0','0','0','send')");
//            db.execSQL("insert into group_notification (creatorID,creatorName,joinerID,joinerName,title,content,create_time,receive_time,confirm_time,status,type) values"+
//                    "('102','tomm','102','jerry','cat and mouse','hahahaha2','2','0','0','0','send')");
//            db.execSQL("insert into group_notification (creatorID,creatorName,joinerID,joinerName,title,content,create_time,receive_time,confirm_time,status,type) values"+
//                    "('103','tommm','102','jerry','cat and mouse','hahahaha3','3','0','0','0','send')");
//            db.execSQL("insert into group_notification (creatorID,creatorName,joinerID,joinerName,title,content,create_time,receive_time,confirm_time,status,type) values"+
//                    "('104','tommmm','102','jerry','cat and mouse','hahahaha4','4','0','0','0','send')");
//            db.execSQL("insert into group_notification (creatorID,creatorName,joinerID,joinerName,title,content,create_time,receive_time,confirm_time,status,type) values"+
//                    "('105','tommmmm','102','jerry','cat and mouse','hahahaha5','5','0','0','0','send')");
//            db.execSQL("insert into group_notification (creatorID,creatorName,joinerID,joinerName,title,content,create_time,receive_time,confirm_time,status,type) values"+
//                    "('106','tommmmm','102','jerry','cat and mouse','hahahaha5','5','0','0','0','receive')");
//            db.execSQL("insert into group_notification (creatorID,creatorName,joinerID,joinerName,title,content,create_time,receive_time,confirm_time,status,type) values"+
//                    "('107','tommmmm','102','jerry','cat and mouse','hahahaha5','5','0','0','0','receive')");
        }
        catch (Exception e){
            e.printStackTrace();
        }
