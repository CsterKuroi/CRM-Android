...
public class CircleProgressBar extends View {
    ...
    private void initTextPaint() {
        ...
        mCpbTextPaint2 = new Paint();
        mCpbTextPaint2.setAntiAlias(true);
        mCpbTextPaint2.setColor(mCpbProgressTextColor);
    }
    ...
    private void drawProgressText(Canvas canvas) {
        ...
        int textSize = (int) ((mMinWidth - mCpbStrokeWidth * 2) / 2.5/2.2);
        ...
        float y = (mMinWidth - textHeight) / 2 + 1.7f*textSize;
        canvas.drawText(text, x, y, mCpbTextPaint);

        String text2 ="本月完成";
        int textSize2 = (int) ((mMinWidth - mCpbStrokeWidth * 2) / 2.5/2.2);
        mCpbTextPaint2.setTextSize(textSize2);
        mCpbTextPaint2.setColor(Color.LTGRAY);
        Paint.FontMetrics fm2 = mCpbTextPaint2.getFontMetrics();
        float textHeight2 = (float) Math.ceil(fm.descent - fm2.top);
        float textWidth2 = mCpbTextPaint2.measureText(text2);
        float x2 = (mMinWidth - textWidth2) / 2;
        float y2 = (mMinWidth - textHeight2) / 2+ 0.4f*textSize;
        canvas.drawText(text2, x2, y2, mCpbTextPaint2);
    }
