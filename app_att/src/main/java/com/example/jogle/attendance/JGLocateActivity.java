...
public class JGLocateActivity extends Activity {
...
//                    Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jg_activity_locate);
...
//        myListener.onReceiveLocation(mLocation);
        ...
        LatLng geolat =new LatLng(JGMainActivity.dataSet.getLatitude(),
                JGMainActivity.dataSet.getLongitude());
        ...
        coder.setOnGetGeoCodeResultListener(new OnGetGeoCoderResultListener() {
            ...
            public void onGetReverseGeoCodeResult(ReverseGeoCodeResult reverseGeoCodeResult) {
                poiData.clear();
                poiData.add(JGMainActivity.dataSet.getPosition());
                for (int i = 0; i < reverseGeoCodeResult.getPoiList().size(); i++) {
                    if (!JGMainActivity.dataSet.getPosition().equals(
        ...
        poiList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                JGMainActivity.dataSet.setPosition(poiData.get(i));
