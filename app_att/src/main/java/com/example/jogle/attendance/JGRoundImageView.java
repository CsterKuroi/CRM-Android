...
public class JGRoundImageView extends ImageView {

    public JGRoundImageView(Context context) {
        super(context);
    }

    public JGRoundImageView(Context context, AttributeSet attrs) {
        super(context, attrs);

    }

    public JGRoundImageView(Context context, AttributeSet attrs, int defStyle) {
