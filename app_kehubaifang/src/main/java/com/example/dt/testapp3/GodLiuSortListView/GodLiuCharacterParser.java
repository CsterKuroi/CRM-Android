 ...
 * 
 */
public class GodLiuCharacterParser {
	...
	private static GodLiuCharacterParser godLiuCharacterParser = new GodLiuCharacterParser();

	public static GodLiuCharacterParser getInstance() {
		return godLiuCharacterParser;
	}
