...
public class ChanceDELETE {
    private final String wsuri = "ws://101.200.189.127:8001/ws";
    //private final String wsuri = "ws://192.168.50.101:8001/ws";
    private String tempjson="";
    private WebSocketConnection mConnection;
    private ChanceDeleteCallBack callBack;
    private String userID;

    public ChanceDELETE(ChanceDeleteCallBack callBack, String userID) {
        this.callBack = callBack;
        this.userID = userID;
    }


    public String deleteJson(Chance chance) {
        try {
            JSONObject object = new JSONObject();

            String jihuiid = String.valueOf(chance.getId());

            object.put("cmd", "deleteopportunity");
            object.put("type", "8");
