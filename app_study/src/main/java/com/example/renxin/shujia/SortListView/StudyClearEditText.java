...
public class StudyClearEditText extends EditText implements
    ...
    public StudyClearEditText(Context context) {
    	this(context, null);
    }

    public StudyClearEditText(Context context, AttributeSet attrs) {
    	//���ﹹ�췽��Ҳ����Ҫ����������ܶ����Բ�����XML���涨��
    	this(context, attrs, android.R.attr.editTextStyle);
    }

    public StudyClearEditText(Context context, AttributeSet attrs, int defStyle) {
