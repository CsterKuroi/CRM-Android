...
public class crmSideBar extends View {
    // �����¼�
    ...
    public crmSideBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public crmSideBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public crmSideBar(Context context) {
        super(context);
    }
