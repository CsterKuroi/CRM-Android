 ...
 *
 */
public class StudyCharacterParser {
	...
	private static StudyCharacterParser characterParser = new StudyCharacterParser();

	public static StudyCharacterParser getInstance() {
