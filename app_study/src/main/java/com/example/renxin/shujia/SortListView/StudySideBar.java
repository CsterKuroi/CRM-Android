...
public class StudySideBar extends View {
    // �����¼�
    ...
    public StudySideBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public StudySideBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public StudySideBar(Context context) {
        super(context);
    }
